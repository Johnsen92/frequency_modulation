...
public class VsimFMParser {
    public static void main(String[] args) {
        try{
            ...
            ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "cd " + currentDir + "\\modelsim" + " && " + "vsim -c testbench_fm -do \"run -a; q\"") ;
            ...
            ProcessBuilder matlabBuilder = new ProcessBuilder("cmd.exe", "/c", "matlab -nosplash -nodesktop -r run('FMPlotter.m')") ;
